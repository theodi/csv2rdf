  ...
  class Cli < Thor
    ...
    private
      ...
      def transform_csv(source, schema, dump, validate, full)
        ...
        transformer = Csvlint::Csvw::Csv2Rdf::Csv2Rdf.new( source, {}, schema, { :minimal => !full, :validate => validate } )
        ...
        ttl = writer.dump(transformer.result, nil, { 
          :standard_prefixes => true, 
          :canonicalize => true, 
          :literal_shorthand => true
        })

        return ttl, transformer.valid?
      end
